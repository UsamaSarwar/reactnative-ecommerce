      ...
      >
        ...
        <View style={UniversalStyles.errorInputContainer}>
          ...
          <View style={UniversalStyles.input_fields_container_1}>
            {state.addr === "" ? null : (
              <Text style={UniversalStyles.marginBottom10}>Email Address</Text>
            )}
            <TextInput
            ...
            {state.pass === "" ? null : (
              <Text style={UniversalStyles.marginBottom10}>Password</Text>
            )}
            <TextInput
            ...
            {state.confirmPass === "" ? null : (
              <Text style={UniversalStyles.marginBottom10}>
                Confirm Password
              </Text>
            )}
            <TextInput
